...
public:
   ...
   void duplica() {
       ...
       while (actual != nullptr) {
           ...
           nuevo = new Nodo (actual->elem, actual->sig);  //Duplicamos el nodo
           
           actual->sig = nuevo; //Hacemos que el actual apunte al suplicado
           actual = nuevo ->sig;      //"Avanzamos" el indice al siguiente de la lista original
