...
public:
   ...
   void colarse(queue<T> colegas, T pringao)
   {
       ...
       while (!colegas.empty()) {
           Nodo* newColegasPrim = colegas.prim->sig;

           colegas.prim->sig = actual->sig;
           actual->sig = colegas.prim;
           colegas.prim = newColegasPrim;
           colegas.nelems--;
           this->nelems++;
           actual = actual->sig;
       }
