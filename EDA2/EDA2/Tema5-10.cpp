...
//		{
//			// si el multiplo es 0 eliminamos el nodo
//			if (mult[i] == 0) {
...
//
//			}
//			// si el multiplo es mayor de 1, añadimos nodos iguales y recolocamos
//			else if (mult[i] > 1) {
//
//				Nodo* nodoSiguiente = nodoActual->sig;
...
//				nodoActual = nodoSiguiente;
//			}
//			// si el multipolo es 1, lo dejamos tal cual y avanzamos el nodo
//			else {
